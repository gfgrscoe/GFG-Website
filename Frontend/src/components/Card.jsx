...
const Card = ({ member }) => {
    ...
    return (
        ...
        >
            {/* Animated linear glow background - pointer-events-none */}
            ...
            <div className="relative h-full bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100">
                ...
                {/* Top linear bar - pointer-events-none */}
                ...
                <div className="relative p-6 flex flex-col items-center">
                    ...
                    {/* Image section with better positioning */}
                    ...
                    {/* Position Badge - NOW CLEARLY VISIBLE */}
                    ...
                    {/* Social Links - WITH PROPER Z-INDEX AND POINTER EVENTS */}
